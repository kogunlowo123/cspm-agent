...
async def test_analyze():
    """Test Primary analysis function for CSPM Agent."""
    tools = AgentTools()
...
@pytest.mark.asyncio
async def test_scan():
    """Test Scan target for issues relevant to CSPM Agent."""
    tools = AgentTools()
...
async def test_report():
    """Test Generate report for CSPM Agent."""
    tools = AgentTools()
...
async def test_agent_initialization():
    ...
    from src.agent.cspm_agent_agent import CspmAgentAgent
    agent = CspmAgentAgent()

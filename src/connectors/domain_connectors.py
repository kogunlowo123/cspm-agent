"""CSPM Agent - Domain-Specific Connectors."""
...
class SiemConnectorConnector:
    """Domain-specific connector for siem connector integration with CSPM Agent."""
...
class EdrConnectorConnector:
    """Domain-specific connector for edr connector integration with CSPM Agent."""
...
class ThreatIntelConnector:
    """Domain-specific connector for threat intel integration with CSPM Agent."""
...
class TicketingSystemConnector:
    """Domain-specific connector for ticketing system integration with CSPM Agent."""
